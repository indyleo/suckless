...
static const char *normbgcolor = "#2E3440"; // dark grayish-blue
static const char *normfgcolor = "#D8DEE9"; // light gray
static const char *selbgcolor = "#4C566A";  // medium gray
static const char *selfgcolor = "#ECEFF4";  // bright white
static const char *urgbgcolor = "#3B4252";  // muted dark blue-gray
static const char *urgfgcolor = "#BF616A";  // red (for urgency)
